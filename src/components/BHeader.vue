  ...
  <div class="container">
    <header class="d-flex justify-content-center py-3">
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <router-link to="/FireRegister" class="nav-link" active-class="active">Firebase Register
          </router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link to="/WeatherCheck" class="nav-link"
          active-class="active">Get Weather</router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link to="/BookInfo" class="nav-link" active-class="active">Get Book Info</router-link>
        </li>
      </ul>
    </header>
  </div>
